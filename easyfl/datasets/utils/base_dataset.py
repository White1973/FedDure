...
class BaseDataset(object):
    ...
    @staticmethod
    def get_setting_folder(dataset, split_type, num_of_client, num_label_per_class, class_per_client,
                           fraction, iid_fraction, user_str, train_test_split, alpha=None, weights=None,s_split_type=None):
        if dataset == CIFAR10 or dataset == CIFAR100 or dataset==CINIC10:
            if s_split_type is not None:
                return "{}_{}_{}_{}_{}_{}_{}_{}".format(dataset, s_split_type, split_type, num_label_per_class, num_of_client, num_label_per_class, class_per_client,
                                                    alpha, 1 if weights else 0)
            else:
                return "{}_{}_{}_{}_{}_{}_{}".format(dataset, split_type, num_of_client, num_label_per_class, class_per_client, alpha,
                                                 1 if weights else 0)
        else:
            if s_split_type is not None:
                return "{}_{}_{}_{}_{}_{}_{}_{}_{}_{}".format(dataset, s_split_type, split_type, num_label_per_class,num_of_client, num_label_per_class,
                                                           class_per_client,fraction, iid_fraction, user_str, train_test_split)
            else:
                return "{}_{}_{}_{}_{}_{}_{}_{}_{}".format(dataset, split_type,num_of_client, num_label_per_class, class_per_client,
    ...
    def sample_customized(self):
        meta_folder = os.path.join(self.base_folder, "meta") #base_folder
